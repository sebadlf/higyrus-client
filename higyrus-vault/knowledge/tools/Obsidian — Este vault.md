...
- **Archivos**: título descriptivo en español, con espacios: `Conceptos Higyrus API.md`
...
- Por proyecto: `higyrus-client`, `[otro-proyecto]`
- Por área: `fintech`, `python`, `devops`, `architecture`, `tools`
